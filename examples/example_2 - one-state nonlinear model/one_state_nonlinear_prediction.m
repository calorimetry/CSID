...
%% Analysis paramter
run_data.model.action = 'predict';  % fit: Calibration; predict: Prediction 

run_data.model.type = 'one state master model with 0 Kelvin ground';
%        M O D E L    T Y P E S
...
experiment_name = 'example_dataset_prediction.csv';
calibration_file = 'example_one_state_nonlinear_calibration_file.mat';
...
fields = {'Hours', 'input_power', 'center_temp', 'room_temp'};
plotRunData( run_data, fields, {'x', 'y1', 'y2', 'y2'});
