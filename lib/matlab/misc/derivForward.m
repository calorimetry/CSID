...
function dydx = derivForward( X, Y )
% derivCentered -- compute forward derivative of two vectors of equal
% length
%
% dydx = derivForward( X, Y )
%
% Inputs
...
dydx = [ 0; (Y(2:nx) - Y(1:nx-1)) ./ (X(2:nx) - X(1:nx-1)) ];
