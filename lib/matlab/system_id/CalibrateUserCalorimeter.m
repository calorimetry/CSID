...
function run_data = CalibrateUserCalorimeter(run_data, varargin)
...
[parameters, var_labels] = SetUserModelParams(model_type);
...
run_data.fit.input_power_threshold = 1e-3; % (Watts)
run_data.fit.input_power_COP_threshold = 1e-3; % (Watts)
